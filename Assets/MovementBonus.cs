...
public class MovementBonus : MonoBehaviour {
  ...
  private Color[] Colors = {Color.blue, Color.cyan, Color.green, Color.magenta, Color.yellow, Color.white, Color.gray };
  ...
  void OnCollisionEnter2D(Collision2D collision) {
    ...
    Velocity.Normalize();
    SR.color = Colors[Random.Range(0,6)];
  }
